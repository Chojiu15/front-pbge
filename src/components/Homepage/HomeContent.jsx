      ...
      <Card.Group>
        <Card centered>
          <Card.Content>
            ...
            <Card.Description>
              Vous souhaitez accéder à l'annuaire et vous possédez déjà un
              compte sur Entreprendre au Pays-Basque
            </Card.Description>
          </Card.Content>
          <Card.Content extra>
        ...
        <Card centered>
          <Card.Content>
            ...
            <Card.Description>
              Vous souhaitez accéder à l'annuaire mais n'avez pas encore de
              compte
            </Card.Description>
          </Card.Content>
          <Card.Content extra>
