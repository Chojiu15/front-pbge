...
export default class NavBarLayout extends Component {
    ...
    render() {
        if (this.props.userData.isAuthenticated === true) {
            return (
                <div>
                    <DesktopConnectedNavBarContainer userData={this.props.userData} children={this.props.children}/>
                    <MobileConnectedNavBarContainer userData={this.props.userData} children={this.props.children}/>
                </div>
            )
        }
        else {
            return (
                <div>
                    <DesktopNavBarContainer userData={this.props.userData} children={this.props.children}/>
                    <MobileNavBarContainer userData={this.props.userData} children={this.props.children} />
                </div>
            )
        }
    }
